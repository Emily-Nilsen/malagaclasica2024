    ...
    <div className="relative bg-white py-16 sm:py-24">
      <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
        <div className="relative sm:py-16 lg:py-0">
          ...
          >
            <div className="absolute inset-y-0 right-1/2 w-full rounded-r-3xl bg-pink3_2024/40 opacity-100 lg:right-72" />
          </div>
          <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
            ...
            <figure>
              ...
              <figcaption className="mt-3 flex items-center text-base text-gray-600">
                <CameraIcon
                  className="h-5 w-5 flex-none text-pinkText2024"
                  aria-hidden="true"
                />
                <span className="ml-2">
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <h4 className="mt-2 text-lg font-bold capitalize italic text-pinkText2024">
              {artist.instrument}
            </h4>
          ...
          <div className="mt-10">
            <div className="mt-10">
              <Link
                href="/artists"
                passHref
                className="text-base font-medium text-pinkText2024 transition duration-200 ease-in-out hover:text-blueText2024"
              >
                {' '}
