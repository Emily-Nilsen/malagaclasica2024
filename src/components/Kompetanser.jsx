const features = [
  ...
  {
    name: 'Konkurs og restrukturering',
    description:
      'Ipsa in earum deserunt aut. Quos minus aut animi et soluta. Ipsum dicta ut quia eius. Possimus reprehenderit iste aspernatur ut est velit consequatur distinctio.',
  },
  {
    name: 'Shipping, offshore og energi',
    description:
      'Ipsa in earum deserunt aut. Quos minus aut animi et soluta. Ipsum dicta ut quia eius. Possimus reprehenderit iste aspernatur ut est velit consequatur distinctio.',
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none ">
          {features.map((feature) => (
            <div className="bg-gray-950 px-8 py-6" key={feature.name}>
