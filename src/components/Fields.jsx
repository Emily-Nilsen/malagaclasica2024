    ...
    <Expandable>
      {({ isExpanded }) => (
        <>
          <div
            id="fagfelt"
            className="overflow-hidden bg-gradient-to-t from-slate-50 pt-24 pb-16 sm:py-32"
          >
                ...
                <div className="lg:ml-auto lg:pl-4 lg:pt-4">
                  <div className="lg:max-w-lg">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600">
                      Christian Flemmen Johansen, partner i Elden Advokatfirma,
                      er en anerkjent advokat med omfattende erfaring innen et
