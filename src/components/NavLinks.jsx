...
export function NavLinks() {
  ...
  return [
    ...
    <Link
      key={label}
      href={href}
      className="relative -mx-3 -my-2 rounded-md px-3 py-2 font-bold capitalize italic text-black2026 transition-colors delay-150 hover:text-black2026 hover:delay-[0ms]"
