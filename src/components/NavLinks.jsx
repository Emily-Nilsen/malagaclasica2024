...
export function NavLinks() {
  ...
  return [
    ...
    <Link
      key={label}
      href={href}
      className="relative -mx-3 -my-2 rounded-md px-3 py-2 font-bold capitalize italic text-pinkText2024 transition-colors delay-150 hover:text-blueGreyDark2024 hover:delay-[0ms]"
